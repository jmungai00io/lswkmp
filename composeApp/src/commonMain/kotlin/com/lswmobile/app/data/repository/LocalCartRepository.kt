...
class LocalCartRepository(
    ...
    private fun createCartItemFromProduct(product: ProductClassic, quantity: Int): CartItem {
        return CartItem(
            ...
            profitCycle = product.profitCycle,
            unitCount = product.unitCount,
            productType = product.productType,
            investmentTerm = product.investmentTerm,
            dividendCycle = product.dividendCycle,
    ...
    private fun createCartItemFromFarmland(farmland: Farmland, quantity: Int): CartItem {
        return CartItem(
            ...
            profitRate = farmland.profitRate,
            profitCycle = farmland.profitCycle,
            unitCount = farmland.unitCount,
